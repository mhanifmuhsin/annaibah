              ...
              <>
                <section className="mx-2 pt-2">
                  <IncomeCard
                    ...
                    categories={categories.filter((cat) => cat.id === "wakaf")}
                  />
                </section>
                <section className="m-2">
                  <InOut
